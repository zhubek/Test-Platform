...
// Generic catalog item detail — each of the item's non-card pages becomes a
// tab; its blocks render filled with this item's values. Works for any public
// group (the group name comes from the route).
...
export default function CatalogItemDetailPage() {
  ...
  const { loading, item, tabs, resolveBlock } = useProfessionDetail(id, group);
    ...
    return (
      <div className="flex items-center justify-center py-24">
        <div className="text-center">
          ...
          <h2 className="mb-2 text-lg font-semibold text-gray-700">Not found</h2>
          <Link
            href={`/explore/${group}`}
            className="text-[0.85rem] text-gray-500 underline underline-offset-2 hover:text-gray-900"
          >
            Back
          </Link>
        </div>
