...
export const orgLicenses: OrgLicense[] = [
  { id: id(), code: "PW-7K2M-X9", name: "Aibek Nurlanov", state: "redeemed", tests: allTests("completed", "completed", "assigned") },
  { id: id(), code: "PW-3F8N-Q2", name: "Dana Serikova", state: "redeemed", tests: allTests("completed", "assigned", "assigned") },
  { id: id(), code: "PW-1D5R-T7", name: "Yerlan Akhmetov", state: "redeemed", tests: allTests("completed", "assigned", "assigned") },
  { id: id(), code: "PW-9P4L-M3", name: "", state: "unredeemed", tests: allTests("assigned", "assigned", "assigned") },
  { id: id(), code: "PW-6T1V-K8", name: "Madina Bekova", state: "redeemed", tests: allTests("completed", "assigned", "completed") },
  { id: id(), code: "PW-2H7W-R5", name: "", state: "unredeemed", tests: allTests("assigned", "assigned", "assigned") },
  { id: id(), code: "PW-8C3Y-N1", name: "Alikhan Tulegenov", state: "redeemed", tests: allTests("completed", "completed", "completed") },
  { id: id(), code: "PW-5B9Z-J4", name: "Aru Zhumabek", state: "redeemed", tests: allTests("assigned", "completed", "assigned") },
  { id: id(), code: "PW-4G6X-P2", name: "", state: "unredeemed", tests: allTests("assigned", "assigned", "assigned") },
  { id: id(), code: "PW-0M8Q-W7", name: "Timur Iskakov", state: "expired", tests: allTests("completed", "assigned", "assigned") },
  { id: id(), code: "PW-7N2D-L9", name: "Saule Amirova", state: "redeemed", tests: allTests("completed", "completed", "assigned") },
  { id: id(), code: "PW-3R5F-T6", name: "", state: "unredeemed", tests: allTests("assigned", "assigned", "assigned") },
];
