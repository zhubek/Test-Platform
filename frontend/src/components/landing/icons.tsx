...
export const Brain = ({ size = 24, className = "" }: IconProps) => (
...
export const School = ({ size = 24, className = "" }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M22 9L12 2 2 9v11a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9z"/><path d="M9 22v-6h6v6"/></svg>
);

export const MapPin = ({ size = 24, className = "" }: IconProps) => (
